...
from networks import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, ResNet18, ResNet18BN_AP, ResNet18BN, ConvNet_Original
...
def get_network(model, channel, num_classes, im_size=(32, 32), net_act=None, net_norm=None, net_pooling=None):
    ...
    elif model == 'ConvNet_Original':
        net = ConvNet_Original(channel=channel, num_classes=num_classes, net_width=net_width, net_depth=net_depth, net_act=net_act, net_norm=net_norm, net_pooling='avgpooling', im_size=im_size)
    elif model == 'LeNet':
